...
# print(type(range(6))) # it returns a range object
# print()
...
# it returns a tuple of (element1, element2, ...) as Zip object
list1 = [1, 2, 3]
list2 = ['a', 'b', 'c']
print("Zipped list:", list(zip(list1, list2)), type(zip(list1, list2)))
print()

# Using all() to check if all elements are True (used in boolean Masking)
...
# it returns a reverse iterator as reversed object
print("Reversed list:", list(reversed(unsorted_list)))
print(type(reversed(unsorted_list)))
print()
...
# it returns a map object after applied to all variables
