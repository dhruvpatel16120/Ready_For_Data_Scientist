...
# Translation methods # use for encoding and decoding
table = str.maketrans("aeiou", "12345") # it will create a translation table and return as dict
# print("table:", table)
# print("type of table:",type(table))
print("translate():", "python programming".translate(table)) # it will replace aeiou with 12345s

# Raw Strings # use for file path
